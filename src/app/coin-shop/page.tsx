      ...
      <div className="my-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs text-neutral-500">
            1 เหรียญ = 1 บาทสำหรับปลดล็อกตอน
          </span>
        </div>
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <h3 className="font-semibold text-xs text-neutral-300 font-prompt truncate">{pkg.name}</h3>
                  ...
                  <div className="pt-3 border-t border-white/[0.06] mt-1 space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-[11px] text-neutral-400">ราคา</span>
                      <span className="text-sm font-bold text-white font-prompt">
