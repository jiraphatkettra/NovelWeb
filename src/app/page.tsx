...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative z-10">
      ...
      {/* ═══════════════ MAIN CONTENT ═══════════════ */}
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-10 relative z-10">
        ...
        {loading && stories.length === 0 ? (
          <section>
            <div className="flex items-center justify-between mb-4">
              <div className="h-5 w-36 bg-kakao-card rounded animate-shimmer" />
            </div>
            <SkeletonRanking />
          </section>
              ...
              {rankingStories.slice(0, 5).map((story, idx) => (
                <TiltCard key={story.id} className="rounded-xl" tiltAmount={5}>
                  ...
                  >
                    ...
                    {/* Cover */}
                    <div className="w-11 h-14 rounded-lg overflow-hidden shrink-0 bg-neutral-900">
                      <img
                        src={story.coverUrl}
                        alt={story.title}
                    ...
                    {/* Info */}
                    <div className="flex-1 min-w-0">
                      <h4 className="text-xs font-semibold text-white truncate font-prompt">
                        {story.title}
                      </h4>
                      ...
                      <div className="flex items-center gap-1.5 mt-1 text-[10px] text-neutral-500">
                        ...
                        <AnimatedNumber value={story.ratingAverage} decimals={1} className="text-white" />
                      </div>
                    </div>
                  </Link>
                </TiltCard>
                  ...
                  >
                    ...
                    <div className="relative aspect-[3/4] w-full rounded-lg overflow-hidden bg-neutral-900">
                      ...
                      {story.contentRating === "MATURE_18" && (
                        <span className="absolute top-1.5 right-1.5 px-1 py-0.5 rounded text-[9px] font-bold bg-red-600 text-white">
                          18+
                        </span>
                      )}
                    </div>
